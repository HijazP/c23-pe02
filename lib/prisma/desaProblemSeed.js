...
function main() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        yield prisma.masalah.deleteMany({});
        yield prisma.desa.deleteMany({});
        yield prisma.desa.createMany({
            data: [
                {
        ...
        const desa1 = yield prisma.desa.findUnique({
            where: {
                email: 'pinogu@gorontalo.id'
            }
        });
        const desa2 = yield prisma.desa.findUnique({
            where: {
                email: 'dataranhijau@gorontalo.id'
            }
        });
        const desa3 = yield prisma.desa.findUnique({
            where: {
                email: 'lewalu@alor.id'
            }
        });
        const desa4 = yield prisma.desa.findUnique({
            where: {
                email: 'aimoli@alor.id'
            }
        });
        ...
        for (let i = 0; i < problems; i++) {
            if (i < 18) {
                yield prisma.masalah.create({
                    data: {
                        namaMasalah: (_a = masalahTemplate[i]) === null || _a === void 0 ? void 0 : _a.namaMasalah,
                        deskripsi: (_b = masalahTemplate[i]) === null || _b === void 0 ? void 0 : _b.deskripsi,
                        desa: {
                ...
                yield prisma.masalah.create({
                    data: {
                        namaMasalah: (_c = masalahTemplate[i]) === null || _c === void 0 ? void 0 : _c.namaMasalah,
                        deskripsi: (_d = masalahTemplate[i]) === null || _d === void 0 ? void 0 : _d.deskripsi,
                        desa: {
                ...
                yield prisma.masalah.create({
                    data: {
                        namaMasalah: (_e = masalahTemplate[i]) === null || _e === void 0 ? void 0 : _e.namaMasalah,
                        deskripsi: (_f = masalahTemplate[i]) === null || _f === void 0 ? void 0 : _f.deskripsi,
                        desa: {
                ...
                yield prisma.masalah.create({
                    data: {
                        namaMasalah: (_g = masalahTemplate[i]) === null || _g === void 0 ? void 0 : _g.namaMasalah,
                        deskripsi: (_h = masalahTemplate[i]) === null || _h === void 0 ? void 0 : _h.deskripsi,
                        desa: {
